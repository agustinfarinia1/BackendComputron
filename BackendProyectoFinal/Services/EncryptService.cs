...
namespace BackendProyectoFinal.Services
{
    public class EncryptService
    {
        ...
        {
            var finalPhrase = config.Value.PrivateKey1 + config.Value.PrivateKey2;
            ...
            var keyDeriver = new Rfc2898DeriveBytes(finalPhrase, salt, 100_000, HashAlgorithmName.SHA256);
